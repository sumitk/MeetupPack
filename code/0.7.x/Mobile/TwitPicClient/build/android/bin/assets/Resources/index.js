  ...
  //Create native button
	...
	postButton.addEventListener('click',function(e) {
	  ...
	  if (Titanium.Network.NETWORK_NONE) {
	    ...
	    var a = Titanium.UI.createAlertDialog({
 	      title:'Whoa There!',
 	      message:'Take it easy, shooter - you should probably select an image first, eh?'
 	    });
 	    a.show();
	  }
	  else if (Titanium.App.Properties.getString('username') == '' || Titanium.App.Properties.getString('password') == '') {
	    var a = Titanium.UI.createAlertDialog({
 	      title:'Whoa There!',
 	      message:'Before you can upload a pic, you\'ll need to go to the settings tab to configure your Twitter login credentials.'
 	    });
 	    a.show();
	  }
	  else {
