function TwitterClient(_username,_password) {
  ...
  this.getAppceleratorTweets = function() {
    ...
    $.ajax({
      method:"GET",
      url: "http://search.twitter.com/search.rss?q=%22appcelerator%22+OR+%22appcelerator+titanium%22+OR+%40titanium+OR+%40appcelerator+OR+%23titanium+OR+%23appcelerator&rpp=15",
      dataType:"text",
      success:function(data) {
        ...
        $(xmlDoc).find("rss channel item").each(function() {
          ...
          html.push('   <div style="float:right;margin:5px 0 5px 10px;"><a href="'+link+'"><img style="border:1px solid #fff;" height="48px" width="48px" src="'+image+'"/></a></div>');
