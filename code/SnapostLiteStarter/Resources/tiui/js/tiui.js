...
window.onload = function()
{
	...
	if (Titanium.Platform.name.indexOf('iPhone') != -1)
	{
		...
		Titanium.UI.Notification = function(options)
		{
			...
			this.getHTML = function()
			{
				return '<div style="height:0px;color:'+this.color+';background:-webkit-gradient(linear, left top, left bottom, from(#555), to(#111));padding:5px;text-align:center">' + this.message + '</div>';
